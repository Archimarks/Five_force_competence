...
class _JoinGameViewState extends State<JoinGameView> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Center(child: SingleChildScrollView(padding: const EdgeInsets.all(20.0), child: orientation == Orientation.portrait ? _portraitLayout() : _landscapeLayout())),
        ],
      ),
    );
  }
  ...
  Widget _portraitLayout() {
    return Column(
      ...
      children: [Image.asset('assets/Icon/LOGO.png', width: 220, fit: BoxFit.contain), const SizedBox(height: 30), _buildTextField(), const SizedBox(height: 20), _buildButton()],
    );
  }
  ...
  Widget _buildTextField() {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color.fromARGB(255, 130, 130, 130).withAlpha((0.6 * 255).toInt()), borderRadius: BorderRadius.circular(12)),
      child: TextField(
        controller: _codeController,
        decoration: const InputDecoration(border: InputBorder.none, hintText: 'Código del equipo', contentPadding: EdgeInsets.symmetric(vertical: 10)),
